...
draw_rainbow(t, 300, 10, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 500, 50, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 100, 5, -random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 10, 50, random.randint(100, 1000), -random.randint(100, 1000))
draw_rainbow(t, 50, 60, -random.randint(100, 1000), -random.randint(100, 1000))
draw_rainbow(t, 50, 30, random.randint(100, 1000), -random.randint(100, 1000))
draw_rainbow(t, 10, 60, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 40, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 40, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 40, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 40, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 90, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 70, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 80, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 40, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 40, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 60, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 40, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 60, 70, random.randint(100, 1000), random.randint(100, 1000))
draw_rainbow(t, 40, 70, random.randint(100, 1000), random.randint(100, 1000))
...
'''
numbers1 = (2,3,4,5,6,7)             # ()로 튜플 만들기
numbers2 =  6,7,8,9,10            # ()없이 튜플 만들기
...
num1 = (1)         # ()로 만든 경우
num2 = (1,)        # (,)로 만든 경우
num3 = 55        # 숫자 1개만 넣어준 경우
num4 = 55,        # 숫자, 로 만들어준 경우
