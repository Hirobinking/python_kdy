...
'''
number = int(input("구독자 수를 입력해주세요"))
if number >= 1000:
    print("수익창출 가능")
else:
    print("수익창출 불가")
...
'''
kor =  int(input("국어 시험 점수는?"))
math = int(input("수학 시험 점수는?"))
Eng = int(input("영어 시험 점수는?"))
average = (kor + math + Eng)/3
all = kor + math + Eng
print(f"합계: {all}")
print(f"평균: {average}")
if average >= 60:
    print("보충대상자가 아닙니다. 즐거운 방학 보내세요 :D~")
else:
    print("보충대상자 입니다. 당신의 방학은 이제 제껍니다 ㅎㅎ")
