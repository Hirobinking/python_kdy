...
def character_info(name, attack, health, speed):
    print(f'이름: [{name}]')# name 출력
    print(f'공격력: [{attack}]')# 기본 공격력(attack) 출력
    print(f'체력: [{health}]')# 기본 체력(health) 출력
    print(f'이동속도: [{speed}]')# 기본 속도(speed) 출력
    print('')
# character1 만들어주기(정보 할당)
character1_name = '케이틀린' ## character1의 name 정의
character1_attack = 100 ## character1의 attack 정의
character1_health = 500 ## character1의 health 정의
character1_speed = 400 ## character1의 speed 정의
...
character2_name = '럭스'  ## character1의 name 정의
character2_attack = 60  ## character1의 attack 정의
character2_health = 400 ## character1의 health 정의
character2_speed = 300  ## character1의 speed 정의
...
character3_name = '야스오'  ## character1의 name 정의
character3_attack = 120  ## character1의 attack 정의
character3_health = 600 ## character1의 health 정의
character3_speed = 400  ## character1의 speed 정의
...
class Character:             # Character class 정의해주기
    def __init__(self, name, attack, health, speed):   # 생성자 정의 - name, attack, health, speed 입력
        ...
        print(f'{self.name}님 소환사의 협곡에 오신것을 환영합니다')     # 소환사 협곡! 환영!

    def character_info(self):  # character_info() 메서드 정의
        print(f'[{self.name}]')          # name 출력
        print(f'공력력: {self.attack}')      # attack 출력
        print(f'기본체력: {self.health}')    # health 출력
        print(f'이동속도: {self.speed}')     # speed 출력
        print()

characer1 = Character('케이틀린', 200, 300, 400)
characer1.character_info()

characer1 = Character('럭스', 60, 400, 300)
characer1.character_info()

characer1 = Character('야스오', 120, 300, 400)
characer1.character_info()
'''
# 첫번째 캐릭터 만들기
# 두번째 캐릭터 만들기
