...
## ※ 결과 확인이 중요!!
'''
numbers = 100, 546, 896, 1, 777, 1, 2, 3, 1
...
print(numbers.index(1))         # .index(): 입력한 숫자의 인덱스를 반환해주는 함수(메서드)
'''
...
print(youtuber['aespa'])     # ()안에 값에 접근하는 문장 넣어주기

## 연습문제3: 딕셔너리 제어2-값 할당(or 수정)하기
## : 자신이 가장 좋아하는 유투버의 구독자 수에 1000이 더 큰 숫자를 넣고 이를 출력해보자


youtuber['aespa'] = 100000000000000              # 딕셔너리 값 할당 명령 수행
print(youtuber['aespa'])
